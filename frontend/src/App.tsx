...
const errorText = (error: unknown) => {
  ...
  if (message.includes('Bruno Engine executable was not found')) return 'O Bruno Engine não foi encontrado. Reinstale o aplicativo usando o instalador completo.'
  return message
}
...
export default function App() {
  ...
  const handleLaunch = async (profileItem: BrowserProfile) => {
    if (!desktopMode) { notify('Use o aplicativo desktop para iniciar o Bruno Engine real.', 'info'); return }
